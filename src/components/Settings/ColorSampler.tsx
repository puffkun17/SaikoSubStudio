      ...
      <div className="flex flex-col gap-3">
        ...
        {!refScreenshot ? (
          ...
          >
            ...
            <span className="text-[10px] text-text-secondary">上传剧照或截图参考</span>
          </div>
        ) : (
          <div className="flex flex-col gap-3">
            ...
            <div className="relative h-20 rounded-lg overflow-hidden border border-white/5 bg-black">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex items-end p-2">
                <span className="text-[10px] font-medium text-white truncate max-w-full">参考剧照加载就绪</span>
              </div>
            </div>

            {/* Target Select */}
            <div className="flex flex-col gap-1.5">
              <span className="text-[10px] text-text-secondary font-bold uppercase tracking-wider">吸色对应目标</span>
                ...
                {(['zhColor', 'zhOutline', 'enColor'] as const).map(target => {
                  ...
                  return (
                    <button
                      key={target}
                      type="button"
                      className={`py-1 text-center rounded text-[10px] font-bold border transition
            ...
            {eyeDropperSupported ? (
              ...
              <div className="p-2.5 bg-amber-500/5 border border-amber-500/20 rounded-lg text-[10px] text-amber-300/80 flex items-start gap-2">
